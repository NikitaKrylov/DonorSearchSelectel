...
//         </div> 
//         <div className="modal__link-wrap"> 
//             Already a redditor?  <span onClick={changeMode} className="modal__link">Log In</span> 
//         </div>   
 
//         <Button className="modal__button" variant="contained" fullWidth>Continue</Button> 
//         </> 
//       ); 
// } 
