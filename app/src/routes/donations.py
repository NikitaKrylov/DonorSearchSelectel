...
from src.schemas.pets import TransactionType, CreateDonationTransactionDTO, GetDonationTransactionDTO, \
    UpdateDonationTransactionDTO, TransactionFilterData
...
@router.get('/{transaction_type}', response_model=list[GetDonationTransactionDTO])
...
@router.post('/{transaction_type}', response_model=GetDonationTransactionDTO | None)
...
@router.get('/{transaction_type}/{transaction_id}', response_model=GetDonationTransactionDTO | None)
