  ...
  return (
    <div className='fdonorform'>
        ...
        <div className='fdonorform__st2'>
            ...
            <div className='fdonorform__st2__inp1'><input placeholder="Причина поиска крови"/></div>
            <div className='fdonorform__st2__inp2'><input placeholder="Нужный объем крови"/></div>
            <div className='fdonorform__st2__inp3'><input placeholder="Порода"/></div>
            <div className='fdonorform__st2__inp4'><input placeholder="Выберите удобную вам клинику"/></div>
            <div className='fdonorform__st2__inp5'><input placeholder="Укажите сроки"/></div>
